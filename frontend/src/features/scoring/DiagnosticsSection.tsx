...
export const DiagnosticsSection: React.FC<DiagnosticsSectionProps> = ({
  ...
  return (
    <section className="flex flex-col gap-5 w-full text-left" aria-label="Content diagnostics">
      {/* Cyber Section Index */}
      <div className="flex flex-wrap items-center justify-between border-b-2 border-[#00FF41]/20 pb-2 font-mechanismo text-[11px] text-[#8E9E90] uppercase tracking-widest">
        <div className="flex items-center gap-2">
          ...
          <span className="text-white/90 font-bold">CONTENT DIAGNOSTICS & SIGNAL FRICTION</span>
        </div>
      ...
      {contentProfile && (hookStrength !== undefined || curiosityGap !== undefined) && (
        <div className="cyber-card p-4 sm:p-5 flex flex-col gap-4 font-mechanismo">
          <div className="flex items-center justify-between border-b border-[#00FF41]/20 pb-2 text-xs">
            ...
            {contentProfile.hook_type && (
              <span className="text-[11px] text-[#000000] bg-[#00FF41] px-2 py-0.5 font-bold border border-[#00FF41] shadow-[0_0_8px_rgba(0,255,65,0.3)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {hookStrength !== undefined && (
              <div className="flex flex-col gap-1.5 bg-[#000000]/60 p-3 border border-[#00FF41]/20">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#8E9E90] font-bold">HOOK RETENTION VELOCITY</span>
                  <span className="font-black text-[#00FF41]">
                    {Math.round(hookStrength <= 1.0 ? hookStrength * 100 : hookStrength)}/100
                  </span>
                </div>
                <div className="h-2 bg-[#000000] border border-[#00FF41]/30 overflow-hidden">
                  <div
                    className="h-full bg-gradient-to-r from-[#00FF41] to-[#66FF8A] shadow-[0_0_8px_#00FF41]"
            ...
            {curiosityGap !== undefined && (
              <div className="flex flex-col gap-1.5 bg-[#000000]/60 p-3 border border-[#00FF41]/20">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#8E9E90] font-bold">CURIOSITY GAP INDEX</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="cyber-card corner-ticks p-5 flex flex-col gap-3 text-left">
          <div className="flex items-center justify-between border-b border-[#00FF41]/20 pb-2 font-mechanismo text-xs">
            <span className="font-black text-[#00FF41] font-csmigrate text-sm tracking-wide uppercase">[+] RETENTION ACCELERATORS</span>
            <span className="text-[10px] text-[#000000] bg-[#00FF41] px-1.5 py-0.5 font-black uppercase">POSITIVE</span>
          </div>
          <ul className="flex flex-col gap-2.5 font-mechanismo text-xs" role="list">
            {strengths.map((item, idx) => (
              <li
                key={idx}
                className="flex items-start gap-2.5 text-[#E2E6EC] bg-[#000000]/90 border border-[#00FF41]/20 hover:border-[#00FF41] p-3 leading-relaxed shadow-[2px_2px_0px_0px_#000] transition-all"
              >
                <span className="text-[#00FF41] font-black shrink-0">[+]</span>
        ...
        <div className="cyber-card corner-ticks p-5 flex flex-col gap-3 text-left">
          <div className="flex items-center justify-between border-b border-[#FF0055]/30 pb-2 font-mechanismo text-xs">
            <span className="font-black text-[#FF0055] font-csmigrate text-sm tracking-wide uppercase">[-] DROP-OFF FRICTION POINTS</span>
            <span className="text-[10px] text-white bg-[#FF0055] px-1.5 py-0.5 font-black uppercase">ATTENTION</span>
          </div>
          <ul className="flex flex-col gap-2.5 font-mechanismo text-xs" role="list">
            {weaknesses.map((item, idx) => (
              <li
                key={idx}
                className="flex items-start gap-2.5 text-[#E2E6EC] bg-[#000000]/90 border border-[#FF0055]/20 hover:border-[#FF0055] p-3 leading-relaxed shadow-[2px_2px_0px_0px_#000] transition-all"
              >
                <span className="text-[#FF0055] font-black shrink-0">[-]</span>
                <span className="font-sans text-xs sm:text-sm">{item}</span>
              </li>
            ))}
          </ul>
